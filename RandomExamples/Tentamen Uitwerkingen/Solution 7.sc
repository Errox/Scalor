...
val interrobang = question andThen exclamation

val addExclamation = makeModifier(exclamation)
val addQuestion = makeModifier(question)
val addInterrobang = makeModifier(interrobang)

addExclamation(message)
addQuestion(message)
addInterrobang(message)
